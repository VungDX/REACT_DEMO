...
import { createProduct, deleteProduct, listProducts, deleteMultipleProducts } from "../actions/productActions";
    ...
    <div>
      <div className="row">
        ...
        <div className="group-button">
          ...
          <button type="button" className="primary" onClick={deleteMultipleHandler}>
            Delete All
          </button>
        </div>
      </div>
        ...
        <table className="table">
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product._id}>
                <td>
                  <input type="checkbox" name={"combobox"} value={product} onChange={() => handleChangeCombobox(product._id)} />
                </td>
                <td>{product._id}</td>
                <td>{product.name}</td>
                <td>{product.price}</td>
